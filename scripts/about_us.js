const membersText = [
  ...
  `In partnership with Incora - full-cycle. software development company, with a deep track record in generative-AI, business automation, voice recognition and custom development. For about a decade, their domain-led engineers turn prototypes into secure, cloud-scale solutions that accelerate product and revenue growth. <br /> <br /> They combine technical experience with industry-specific knowledge, ensuring every product is built to last and scale. Incora delivers solutions that help businesses grow & operate smarter.`,
];
